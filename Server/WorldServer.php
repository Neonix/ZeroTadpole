...
class WorldServer 
{
    ...
    public $eliteMobSpawnInterval = 4; // Plus rapide: 4 secondes au lieu de 8
    public $eliteMobBroadcastInterval = 0.25;
    public $eliteMobMaxCount = 12; // Plus de mobs: 12 au lieu de 2
    ...
    {
        return array(
            // === TIER 1: MOBS DE BASE (spawns fréquents) ===
            'crab_small' => array(
                'mobType' => 'crab_small',
                'name' => 'Petit Crabe',
                'icon' => '🦀',
                ...
                'spawnWeight' => 40,
                'xpReward' => 10,
                'dropTable' => array('potion_health', 'spell_bubble'),
                'dropChance' => 0.4,
            ),
            'jellyfish' => array(
                'mobType' => 'jellyfish',
                ...
                'spawnWeight' => 30,
                'xpReward' => 20,
                'dropTable' => array('potion_health', 'potion_speed', 'spell_wave'),
                'dropChance' => 0.5,
            ),
            
            // === TIER 2: MOBS DANGEREUX ===
            'crab_giant' => array(
                'mobType' => 'crab_giant',
                'name' => 'Crabe Géant',
                'icon' => '🦞',
                ...
                'spawnWeight' => 20,
                'xpReward' => 40,
                'dropTable' => array('potion_health', 'potion_health_large', 'shield_bubble'),
                'dropChance' => 0.5,
            ),
            'electric_eel' => array(
                'mobType' => 'electric_eel',
                ...
                'spawnWeight' => 15,
                'xpReward' => 35,
                'dropTable' => array('spell_lightning', 'potion_speed'),
                'dropChance' => 0.45,
            ),
            ...
            'shark_mini' => array(
                ...
                'spawnWeight' => 10,
                'xpReward' => 80,
                'dropTable' => array('potion_health_large', 'spell_lightning', 'shield_bubble'),
                'dropChance' => 0.75,
            ),
            'manta_ray' => array(
                'mobType' => 'manta_ray',
                ...
                'spawnWeight' => 8,
                'xpReward' => 70,
                'dropTable' => array('spell_wave', 'spell_vortex', 'potion_speed'),
                'dropChance' => 0.7,
            ),
            ...
            'octopus_boss' => array(
                ...
                'spawnWeight' => 3,
                'xpReward' => 300,
                'dropTable' => array('spell_vortex', 'spell_heal', 'shield_bubble'),
                'dropChance' => 1.0,
                'guaranteedDrops' => 2,
            ),
            'kraken' => array(
                ...
                'spawnWeight' => 2,
                'xpReward' => 600,
                'dropTable' => array('spell_vortex', 'spell_heal', 'spell_lightning', 'shield_bubble'),
                'dropChance' => 1.0,
                'guaranteedDrops' => 2,
            ),
            
            // === TIER 5: BOSS LÉGENDAIRE ===
            'leviathan' => array(
                'mobType' => 'leviathan',
                'name' => 'Léviathan',
                'icon' => '🐉',
                ...
                'spawnWeight' => 1,
                'xpReward' => 750,
                'dropTable' => array('spell_vortex', 'spell_heal', 'spell_lightning'),
                'dropChance' => 1.0,
                'guaranteedDrops' => 3,
            ),
        );
