...
(function() {
    ...
    window.AdvancedSystems = {
        ...
        createPanels: function() {
            ...
            container.innerHTML = `
                ...
                <div id="quick-action-bar">
                    <div class="action-slot" data-slot="1" onclick="AdvancedSystems.useQuickSlot(1)">
                        <span class="action-key">1</span>
                        <div class="action-icon" id="quick-slot-1"></div>
                        <div class="action-cooldown" id="quick-cd-1"></div>
                    </div>
                    <div class="action-slot" data-slot="2" onclick="AdvancedSystems.useQuickSlot(2)">
                        <span class="action-key">2</span>
                        <div class="action-icon" id="quick-slot-2"></div>
                        <div class="action-cooldown" id="quick-cd-2"></div>
                    </div>
                    <div class="action-slot" data-slot="3" onclick="AdvancedSystems.useQuickSlot(3)">
                        <span class="action-key">3</span>
                        <div class="action-icon" id="quick-slot-3"></div>
                        <div class="action-cooldown" id="quick-cd-3"></div>
                    </div>
                    <div class="action-slot" data-slot="4" onclick="AdvancedSystems.useQuickSlot(4)">
                        <span class="action-key">4</span>
                        <div class="action-icon" id="quick-slot-4"></div>
                        <div class="action-cooldown" id="quick-cd-4"></div>
                    </div>
                    <div class="action-slot pet-slot" onclick="AdvancedSystems.togglePetAbility()">
                        <span class="action-key">P</span>
                        <div class="action-icon" id="pet-ability-icon">🐾</div>
                        <div class="action-cooldown" id="pet-ability-cd"></div>
                    </div>
                </div>
        ...
        setupHandlers: function() {
            ...
            document.addEventListener('keydown', (e) => {
                ...
                switch(e.key) {
                    ...
                    case '1': this.useQuickSlot(1); break;
                    case '2': this.useQuickSlot(2); break;
                    case '3': this.useQuickSlot(3); break;
                    case '4': this.useQuickSlot(4); break;
        ...
        renderEvents: function() {
            ...
            if (this.events.active.length === 0) {
            ...
            if (this.events.worldBosses.length === 0) {
                bossesHtml += '<div class="no-bosses">Aucun boss actif</div>';
            } else {
                this.events.worldBosses.forEach(boss => {
